...
<path opacity="0.5" d="M15 5H9" stroke="currentColor" stroke-width="1.5" stroke-linecap="round"/>
<circle opacity="0.5" cx="12" cy="17" r="2" stroke="currentColor" stroke-width="1.5"/>
</svg>
</template>
