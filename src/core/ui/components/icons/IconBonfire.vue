...
<path opacity="0.5" d="M4 15L9 17.1875M20 22L14.5 19.5938" stroke="currentColor" stroke-width="1.5" stroke-linecap="round"/>
<path opacity="0.5" d="M15 10C14.8 10.6667 13.92 12 12 12" stroke="currentColor" stroke-width="1.5" stroke-linecap="round"/>
</svg>
</template>
