...
<path d="M3 17L4.20414 18.3379C4.58342 18.7594 5.12375 19 5.69073 19H18.3093C18.8762 19 19.4166 18.7594 19.7959 18.3379L21 17" stroke="currentColor" stroke-width="1.5" stroke-linecap="round" stroke-linejoin="round"/>
...
<path opacity="0.5" d="M7 15.5H7.37868C8.73694 15.5 10.0396 14.9604 11 14" stroke="currentColor" stroke-width="1.5" stroke-linecap="round"/>
<path opacity="0.5" d="M16.5 10C17.8131 10.3283 19.1869 10.3283 20.5 10" stroke="currentColor" stroke-width="1.5" stroke-linecap="round"/>
</svg>
</template>
