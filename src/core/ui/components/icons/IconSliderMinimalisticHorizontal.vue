...
<path opacity="0.5" d="M4.5 3L19.5 3" stroke="currentColor" stroke-width="1.5" stroke-linecap="round"/>
<path opacity="0.5" d="M4.5 21L19.5 21" stroke="currentColor" stroke-width="1.5" stroke-linecap="round"/>
</svg>
</template>
