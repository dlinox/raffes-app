...
<path opacity="0.5" d="M18 17V18" stroke="currentColor" stroke-width="1.5" stroke-linecap="round"/>
<path opacity="0.5" d="M15.5 17V18" stroke="currentColor" stroke-width="1.5" stroke-linecap="round"/>
<path opacity="0.5" d="M13 17V18" stroke="currentColor" stroke-width="1.5" stroke-linecap="round"/>
<path opacity="0.5" d="M10.5 17V18" stroke="currentColor" stroke-width="1.5" stroke-linecap="round"/>
</svg>
</template>
