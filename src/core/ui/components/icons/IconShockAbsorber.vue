...
<path opacity="0.5" d="M14 20C14 21.1046 13.1046 22 12 22C10.8954 22 10 21.1046 10 20C10 18.8954 10.8954 18 12 18C13.1046 18 14 18.8954 14 20Z" stroke="currentColor" stroke-width="1.5"/>
...
<path opacity="0.5" d="M14 15.5V5.5" stroke="currentColor" stroke-width="1.5"/>
<path opacity="0.5" d="M10 15.5V6" stroke="currentColor" stroke-width="1.5"/>
<path d="M8 8L16 10M8 11.5L16 13.5" stroke="currentColor" stroke-width="1.5" stroke-linecap="round"/>
<path opacity="0.5" d="M20 11.4995L22 11.4995M4 11.5005H2M19.0713 14.3L19.7784 15M4.92871 14.3L4.2216 15M19.0713 8.69996L19.7784 8M4.92871 8.69996L4.2216 8" stroke="currentColor" stroke-width="1.5" stroke-linecap="round"/>
</svg>
</template>
