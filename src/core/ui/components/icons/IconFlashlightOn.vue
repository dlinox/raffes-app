...
<path opacity="0.5" d="M4.5 11H19.5" stroke="currentColor" stroke-width="1.5" stroke-linecap="round"/>
<path opacity="0.5" d="M12 5V2" stroke="currentColor" stroke-width="1.5" stroke-linecap="round"/>
...
<path opacity="0.5" d="M12 19V21" stroke="currentColor" stroke-width="1.5" stroke-linecap="round"/>
</svg>
</template>
