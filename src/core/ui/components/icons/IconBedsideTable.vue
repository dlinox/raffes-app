...
<path opacity="0.5" d="M19 22V20.5M5 22V20.5" stroke="currentColor" stroke-width="1.5" stroke-linecap="round"/>
...
<path d="M13 5C13 5.55228 12.5523 6 12 6C11.4477 6 11 5.55228 11 5C11 4.44772 11.4477 4 12 4C12.5523 4 13 4.44772 13 5Z" fill="#1C274C"/>
...
<path opacity="0.4" d="M2 14H22" stroke="currentColor" stroke-width="1.5" stroke-linecap="round"/>
<path opacity="0.4" d="M2 8H22" stroke="currentColor" stroke-width="1.5" stroke-linecap="round"/>
</svg>
</template>
