...
<path opacity="0.5" d="M12 22V15" stroke="currentColor" stroke-width="1.5" stroke-linecap="round"/>
...
<path opacity="0.5" d="M17.5 15V17" stroke="currentColor" stroke-width="1.5" stroke-linecap="round"/>
</svg>
</template>
