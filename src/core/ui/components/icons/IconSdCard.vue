...
<path opacity="0.5" d="M7 6V9" stroke="currentColor" stroke-width="1.5" stroke-linecap="round"/>
<path d="M10 6V9" stroke="currentColor" stroke-width="1.5" stroke-linecap="round"/>
<path opacity="0.5" d="M13 6V9" stroke="currentColor" stroke-width="1.5" stroke-linecap="round"/>
</svg>
</template>
